...
export default function RouteE() {
	return (
		<RouteDetail
			...
			description="Usted se encuentra en una de las avenidas principales de Benidorm, lo que facilita su desplazamiento hacia los bautismos.
...
El mapa a continuación muestra la ubicación exacta de la parada de autobús más cercana en la Avenida Mediterráneo."
			mapUrl="https://maps.app.goo.gl/28AG8H8euJKK1a517"
		/>
	);
}
